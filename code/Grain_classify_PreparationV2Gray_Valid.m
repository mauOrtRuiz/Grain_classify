...
for k=1:totales(1)
    ...
    dir_outim = fullfile('D:\300123\Documentos\Proyecto_GrainSize\ValidationGray\Finos\');
...
for k=Grandes:Grandes+totales(2)-1
    ...
    if(bandera==1)
    dir_outim = fullfile('D:\300123\Documentos\Proyecto_GrainSize\ValidationGray\Grandes\');
    imagenS=Imn(1:224,1:224,:);
    Augmentation_1
    imagenS=Imn(1:224,225:225+223,:);
    Augmentation_1
...
for k=Medianos:Medianos+totales(3)-1
   ...
   % Imn=imresize(Imna,factor);
    ...
    Imn=gray2rgb(Imn);
    dir_outim = fullfile('D:\300123\Documentos\Proyecto_GrainSize\ValidationGray\Medianos\');
    imagenS=Imn(1:224,1:224,:);
    Augmentation_1
    imagenS=Imn(1:224,225:225+223,:);
    Augmentation_1
